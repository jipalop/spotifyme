<template>
    <div class="container">
        <h1 class="welcome text-center">Welcome to <br> SpotifyMe!</h1>
        <div class="card card-container">
            <h2 class='login_title text-center'>Login</h2>
            <hr>

            <form class="form-signin" @submit.prevent="login_call">
                <span id="reauth-email" class="reauth-email"></span>
                <p class="input_title">Email</p>
                <input type="text" id="inputEmail" class="login_box" placeholder="user01@IceCode.com" required
                       autofocus>
...
<script>
    ...
    export default {
        ...
        methods: {
            login_call(callback) {
                let CLIENT_ID = '3865daab34f34ad4b45d7e8f730fc2ef';
                let REDIRECT_URI = 'http://localhost/spotifyme/public/index.php/';
            ...
            getAuth() {
                this.login_call(function (accessToken) {
